...
enum WeatherData {
    ...
    func icon(isDay: Bool = true) -> String {
        switch self {
        case .clear: isDay ? "sun.min" : "moon"
        case .mainlyClear: isDay ? "cloud.sun" : "cloud.moon"
        case .partialCloudy: isDay ? "cloud.sun" : "cloud.moon"
        case .overcast: "cloud"
        case .fog: "cloud.fog"
        case .lightDrizzle: "cloud.drizzle"
        case .moderateDrizzle: "cloud.drizzle"
        case .denseDrizzle: "cloud.drizzle"
        case .lightFreezingDrizzle: "cloud.drizzle"
        case .heavyFreezingDrizzle: "cloud.drizzle"
        case .lightRain: "cloud.rain"
        case .moderateRain: "cloud.rain"
        case .heavyRain: "cloud.rain"
        case .freezingLightRain: "cloud.rain"
        case .freezingHeavyRain: "cloud.rain"
        case .slightSnowFall: "cloud.snow"
        case .moderateSnowFall: "cloud.snow"
        case .heavySnowFall: "cloud.snow"
        case .snowGrains: "snowflake"
        case .slightRainShowers: "cloud.rain"
        case .moderateRainShowers: "cloud.rain.fill"
        case .violentRainShowers: "cloud.rain.fill"
        case .slightSnowShowers: "cloud.snow.fill"
        case .heavySnowShowers: "cloud.snow.fill"
        case .thunderstorm: "cloud.bolt.rain"
        case .slightThunderstorm: "cloud.bolt.rain"
        case .heavyThunderstorm: "cloud.bolt.rain"
        }
    }
    ...
    var title: String {
        ...
        case .slightSnowFall: return "Fucking snowflakes <<drifting>> lazily"
    ...
    var color: String {
        switch self {
        case .clear: return "#Ee0b0f"
        case .mainlyClear: return "#05c2e8"
        case .partialCloudy: return "#E8a805"
        case .overcast: return "#909090"
        case .fog: return "#Ff870b"
        case .lightDrizzle: return "#0b90ff"
        case .moderateDrizzle: return "#4572ea"
        case .denseDrizzle: return "#C745ea"
        case .lightFreezingDrizzle: return "#45c1ea"
        case .heavyFreezingDrizzle: return "#45eadf"
        case .lightRain: return "#0dffee"
        case .moderateRain: return "#8b8ad8"
        case .heavyRain: return "#40985b"
        case .freezingLightRain: return "#45eadf"
        case .freezingHeavyRain: return "#A35bb1"
        case .slightSnowFall: return "#345651"
        case .moderateSnowFall: return "#Ea1153"
        case .heavySnowFall: return "#Ee6791"
        case .snowGrains: return "#Eeac67"
        case .slightRainShowers: return "#67ee86"
        case .moderateRainShowers: return "#A07280"
        case .violentRainShowers: return "#118eea"
        case .slightSnowShowers: return "#74a9d2"
        case .heavySnowShowers: return "#Aa54aa"
        case .thunderstorm: return "#834f38"
        case .slightThunderstorm: return "#C72745"
        case .heavyThunderstorm: return "#A43349"
        }
    }
}
